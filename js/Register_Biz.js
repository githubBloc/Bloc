...
$(document).ready(function(){ 
	...
	var Service_City1 = $("input[name='City1']");
	...
	//check for duplicate of business
...
var hours = {"01:00 am ":"01:00 am ","02:00 am ":"02:00 am ","03:00 am ":"03:00 am ","04:00 am ":"04:00 am ","05:00 am ":"05:00 am ","06:00 am ":"06:00 am ","07:00 am ":"07:00 am ","08:00 am ":"08:00 am ",
			 "09:00 am ":"09:00 am ","10:00 am ":"10:00 am ","11:00 am ":"11:00 am ","12:00 pm":"12:00 pm","01:00 pm":"01:00 pm","02:00 pm":"02:00 pm","03:00 pm":"03:00 pm","04:00 pm":"04:00 pm",
			 "05:00 pm":"05:00 pm","06:00 pm":"06:00 pm","07:00 pm":"07:00 pm","08:00 pm":"08:00 pm","09:00 pm":"09:00 pm","10:00 pm":"10:00 pm","11:00 pm":"11:00 pm","12:00 am ":"12:00 am "};

$.each(hours, function(key,value){
$("select[name='Hours_Monday'], select[name='Hours_Monday2']").append($("<option></option>").attr("value",key).text(value));
$("select[name='Hours_Tuesday'], select[name='Hours_Tuesday2']").append($("<option></option>").attr("value",key).text(value));
$("select[name='Hours_Wednesday'], select[name='Hours_Wednesday2']").append($("<option></option>").attr("value",key).text(value));
$("select[name='Hours_Thursday'], select[name='Hours_Thursday2']").append($("<option></option>").attr("value",key).text(value));
$("select[name='Hours_Friday'], select[name='Hours_Friday2']").append($("<option></option>").attr("value",key).text(value));
$("select[name='Hours_Saturday'], select[name='Hours_Saturday2']").append($("<option></option>").attr("value",key).text(value));
$("select[name='Hours_Sunday'], select[name='Hours_Sunday2']").append($("<option></option>").attr("value",key).text(value));
});
...
$("#Categories4").change(function() {

        var first = $(this),
            second = $("#Sub_Categories4"),
            key = first.val(),
            // instead of the original switch code
            vals = data[key] == undefined ? data.base : data[key],
            html = [];
...
if(!Reg_Exp_Number.test(Phone_Number.val())){$('#Phone_Required').html("<label style='color:red'>Incorrect Phone Number Format xxxxxxxxxx</label>"); $('html,body').animate({scrollTop: $('#Phone_Required').offset().top-20},2000);return false;}
...
if(!IsEmpty(first,$('#Categories_Required'))){ return false; } if(!IsEmpty(second,$('#Categories_Required'))){ return false; } 
			...
			if(!IsEmpty(Tag1, $('#Tag_Required'))){ return false; }
				if(!IsEmpty(Service_City1, $('#Service_Required'))) { return false; }
	...
	Check_Blur(Service_City1, $('#Service_Required'));
