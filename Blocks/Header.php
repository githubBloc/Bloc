...
<div id="header">
    ...
    <div id="Sign_Register">
        	...
        	<div id="Languages">
                ...
                <div id="Navi_Menu">
                	<ul> 
                		<li><a id='Home_Nav' href="../index.php" title="Home">HOME</a></li>
                        <li><a id='Categories_Nav' href="#" title="Repair">CATEGORIES</a></li>
                        <li><a id='Advertise_Nav' href="../OfferPage.php">ADVERTISE</a></li>
                        <li><a id='Blog_Nav' href="#">BLOG</a></li>
                        <li><a id='AboutUS_Nav'  href="../AboutUS.php">ABOUT</a></li>
                        <li><a id='Contact_US_Nav'  href="../Contact_US.php" title="About">CONTACT US</a></li>
                        <li><a id='Afisha_Nav' href="#" title="About">AFISHA</a></li>
                	</ul>
                </div>
