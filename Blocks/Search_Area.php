	...
	<div class="Search_Area">
    	<div id="Search_Fields">
           	<ul>
            	<form action="SearchList.php" method="post" id="SearchForm" style="float:left">
            	...
            	<li id="Near_Area_li"> <input id="Near_Area_Input" type="text" name="SearchNear" autocomplete="on" placeholder="NEAR"> </li>
           		...
           		<li id="Register_links_2"><?php if(!isset($_SESSION['Email'])) { echo "<a href='Register.php' title='Click to Sing in'>Sign In</a>"; }else{}?>
                ...
                <div style="background-color:rgb(231,235,236); background-color:rgba(231,235,236,0.9);" id="Sign_In2">
                		...
                		<form>
                            ...
                            <input type="submit" id="Submit2" name="Submit" style="font-size:10px;" value="Submit">
                            </div>
                            <h6><a id="Forgot_Password2" style="border:none;"href="#">If you forgot Password</a></h6>
                </div>
                </li>
          		<li id="Register_links_3"><?php if(!isset($_SESSION['Email'])) { echo "<a href='Register.php' title='Click to register'>Register</a>";}else{}?></li>
