...
<head>
<meta charset="UTF-8">
<title>Register Basic Business</title>
<script type="text/javascript" src="../js/RegisterBasic.js"></script>
...
<option value="WI">Wisconsin</option><option value="WY">Wyoming</option>
                     ...
                     <p>Web Address:</p><input  id="Web_Address" name="Web_Address" type="text" size="30"><br><br>
                     ...
                     <br><br>
                      ...
                      <br>
                    <p>About Company: <span id="Star">* </span><span id="About_Required"></span><br><br>Your Limit is:  <span style="text-align:right"; id="Limit"></span> characters.</p> 
