...
$results = mysql_query("SELECT id, BizType, Business_Name, Address, City, State, Zip_Code, Phone_Number, ClaimId FROM Claim_Requests");
$counter2= 1;
while($row = mysql_fetch_array($results))
{
	echo "<a href='#' id='ClaimProfileLink' data-claimid='".$row['ClaimId']."' data-id='".$row['id']."'>
		<div class='List'>
			<h4>".$row['BizType']. "</h4>
